...
const prefixCls = 'dk-message';
const iconPrefixCls = 'dk-icon';
const prefixKey = 'dk_message_key_';
...
function notice(content = '', duration = defaults.duration, type, onClose = function () { }, closable = false, render = function () { }) {
    ...
    // if loading
    const loadCls = type === 'loading' ? ' dk-load-loop' : '';
